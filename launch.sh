...
if ! [[ -f 'DawnCraft%202.0.15%20Serverpack.zip' ]]; then
	rm -fr config kubejs libraries mods *.zip forge*.jar
	curl -Lo 'DawnCraft%202.0.15%20Serverpack.zip' 'https://edge.forgecdn.net/files/6312/852/DawnCraft%202.0.15%20Serverpack.zip' && unzip -u -o 'DawnCraft%202.0.15%20Serverpack.zip' -d /data
