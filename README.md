# [DawnCraft - 2.0.16_hf](https://www.curseforge.com/minecraft/modpacks/dawn-craft) on Curseforge
...
The docker on first run will download the same version as tagged of `DawnCraft - 2.0.16_hf` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "DawnCraft - 2.0.16_hf Server Powered by Docker"
* LEVEL world
...
## Source
Github: https://github.com/Goobaroo/docker-dawncraft

Docker: https://hub.docker.com/repository/docker/goobaroo/dawncraft